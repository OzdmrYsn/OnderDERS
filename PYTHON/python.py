...
# print("Araba markası: {}".format(marka))
...
# print(f'Hoşgeldin {KullaniciAdi}, Şifren: {Sifre}')
...
# sinav1 = int(input("Sınav1 Giriniz: "))
# sinav2 = int(input("Sınav2 Giriniz: "))
# sinav3 = int(input("Sınav3 Giriniz: "))
...
# taban = int(input("Üçgenin Kenar Uzunluğunu Giriniz: "))
# Yükseklik = int(input("Üçgenin Uzunluğunu Giriniz: "))
...
# vize = int(input("Vize Notunuzu Giriniz: "))  #0.40 60
# Final = int(input("Final Notunuzu Giriniz: ")) #0.60 40
...
# #*kullanıcıdan 3 ufarklı değer alınız bu değerleri ekrana yazdırırken aralarına *** işareti koyunuz
#   #*mesela ahmet***yasin***rojin
...
# print(meyveler)
# meyveler = input("Meyve Girin (Virgül Kullanın): ")
# meyveler = meyveler.split(",")
# print(meyveler)
...
# # text = "SELAM BEN yasin ozdemir"
# # text = text.lower()
# # print(text)
# metin = "ONDER BİLGİSAYAR KUrsUNda DErs öğREniyorUM"
# metin = metin.lower()
# print(metin)
...
# text = "Selam Ben Yasin Özdemir"
# text = text.istitle()
# print(text)

# # Kullanıcıdan gün ve saat bilgisi alın
# # gun = input("Haftanın gününü girin (Pazartesi, Salı, Çarşamba, Perşembe, Cuma, Cumartesi, Pazar): ").strip().lower()
# # saat = int(input("Saat bilgisini girin (0-24 arasında bir saat): "))

# # # Hafta içi günler listesi
# # hafta_ici = ["pazartesi", "salı", "çarşamba", "perşembe", "cuma"]

# # # Mesai saati kontrolü
# # if gun in hafta_ici and 9 <= saat <= 17:
# #     print("Mesai saatleri içindesiniz.")
# # else:
# #     print("Mesai dışı.")
...
# if(kllaniciKontrol==True):
#   print("Teşekkürler",girilenKullanici)
# else:
#   print("Hatalı Kullanım Baş Harfi Büyüt")

# kullanicidi = input("usurname")
# konrol = kullanicidi.istitle()
# if (konrol==True):
#     print(f'hoşgldiniz {kullanicidi}')
# else:
#     print("hatalı kullnıcı adı")
...
# benimlistem = ["İbrahim","Gökhan","Esma","Ege","Alihan"]
# print(benimlistem)
# benimlistem.pop()
# print(benimlistem)
...
# if yas>=18:
#     print(f'Selam {isim}, Reşitsin Tebrikler!')
# else:
#     print(f'Selamlar {isim}, Reşit olmana {18-yas} Sene var.')
...
# Deger = int(input("Alıveriş Tutarı Giriniz?: "))

# if Deger <100:
#     print(f'Kargo ücreti eklendi, Ödenecek tutar {Deger+15}')

# else:
#     print(f'Ödenecek Tutar: {Deger}')
...
# if renk == "Mavi":
#     print("Girilen Renk Mavi İF")
# elif renk == "Sarı":
#     print("Girilen Renk Sarı ELİF")
# elif renk == "Yeşil":
#     print("Girilen Renk Yeşil ELİF")
# elif renk == "Mor":
#     print("Girilen Renk Mor ELİF")
# elif renk == "Pembe":
#     print("Girilen Renk Pembe ELİF")
...
# # secilenislem = input("İşlemi Giriniz Ç-T-X-B")
...
# # if kullaniciadi=="Ahmet" and sifre==123:
...
# # *basit bir bankamatik uygulaması oluşturunuz123
# # sifre = "123"
# # bakiye = 2500
...
# #     if girilenTutar<=bakiye and girilenTutar>0:
...
# # import random
# # !random()
# #?randomu kullanmak için randomu importlamamız gerekmektedir
# # import random

# # print(random.randrange(1,10)) #*random.randrange ile başlangıç ve bitiş değerini belirtir

# # sinif = ["ahmet","ayşe","fatma","selim","mert","selim2","mert2","selim3","mert3",]
# # sinifSecim = random.choice(sinif)
# # print(sinifSecim)
...
# # rstRenk = random.choices(renkler, k=2)
# # print(rstRenk)
...
# # import random
# import random
# # randomsayi = random.randint(1,5)

# # sayitahmin = int(input("Sayıyı Giriniz"))

# # if randomsayi == sayitahmin:
...
# # rastgelehava = random.choice(havadurumu)
# # if rastgelehava == "yağışlı":
# #     print("Bugün Hava yağışlı")
# # elif rastgelehava == "karlı":
# #     print("Bugün Hava karlı sıkı giyin")
# # elif rastgelehava == "güneşli":
# #     print("Bugün hava güneşli gözlük tak")
# # else:
# #     print("Hatalı")
...
# # for i in range(1,10): #?1 ile 9 arasında değerler girilir
# #   print(i)
...
#     alt_limit = 0
#     ust_limit = 100
#     print(f"Lütfen {alt_limit}-{ust_limit} arasında bir sayı tutun ve bilgisayarın tahmin etmesini izleyin.")
#     input("Devam etmek için Enter'a basın...")
    
#     while alt_limit <= ust_limit:
#         tahmin = (alt_limit + ust_limit) // 2
#         print(f"Bilgisayarın tahmini: {tahmin}")
#         cevap = input("Sayı bu mu? (e/h): ").lower()
        
#         if cevap == 'e':
#             print(f"Bilgisayar doğru tahmin etti! Tuttuğunuz sayı: {tahmin}")
#             break
#         elif cevap == 'h':
#             yukari_asagi = input("Tuttuğunuz sayı daha büyük mü küçük mü? (b/k): ").lower()
#             if yukari_asagi == 'b':
#                 alt_limit = tahmin + 1
#             elif yukari_asagi == 'k':
#                 ust_limit = tahmin - 1
#             else:
#                 print("Lütfen 'b' ya da 'k' girin!")
#         else:
#             print("Lütfen 'e' ya da 'h' girin!")
#     else:
#         print("Böyle bir sayı bulunamadı! Aralığı doğru verdiğinizden emin olun.")
